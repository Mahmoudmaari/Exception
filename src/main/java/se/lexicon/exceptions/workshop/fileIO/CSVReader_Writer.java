...
public class CSVReader_Writer {
    ...
    public static void saveLastNames(List <String> lastNames){
			...
			try {
				...
				// TODO Auto-generated catch block
				System.out.println("You try to add a lastname that already exists "+e);
			}
    ...
    public static void saveFemaleNames(List <String> femaleNames){
		...
		try {
			...
			// TODO Auto-generated catch block
			System.out.println("You try to add a femalename that already exists "+e);
		}
    ...
    public static void saveMaleNames(List <String> maleNames){
		...
		try {
			...
			// TODO Auto-generated catch block
			System.out.println("You try to add a malename that already exists "+e);
		}
